...
if __name__ == "__main__":
    ...
    # if os.path.exists('detections_MOG_MOG2_GMG.pkl'):
    #     with open('detections_MOG_MOG2_GMG.pkl', 'rb') as p:
    #         print("Reading detections_MOG_MOG2_GMG from detections_MOG_MOG2_GMG.pkl")
    #         detections_MOG_MOG2_GMG = pickle.load(p)
    #         detectionsMOG = detections_MOG_MOG2_GMG[0]
    #         detectionsMOG2 = detections_MOG_MOG2_GMG[1]
    #         detectionsGMG = detections_MOG_MOG2_GMG[2]
    #         print("detections_MOG_MOG2_GMG loaded\n")
